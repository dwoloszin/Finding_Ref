...
def CarrierAggregationFunction(TEC):
...
frame_tableList.drop(frame_tableList[frame_tableList['TableList'] != 'CarrierAggregationFunction'].index, inplace=True)
TEC_List = frame_tableList['TEC'].tolist()

for i in TEC_List:
  CarrierAggregationFunction(i) 