...
def QciProfileEndcConfigExt(TEC):
...
frame_tableList.drop(frame_tableList[frame_tableList['TableList'] != 'QciProfileEndcConfigExt'].index, inplace=True)
TEC_List = frame_tableList['TEC'].tolist()

for i in TEC_List:
  QciProfileEndcConfigExt(i) 
